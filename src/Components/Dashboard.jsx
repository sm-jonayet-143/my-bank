    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Deposit */}
          <div className="bg-purple-200 p-8 rounded shadow">
          ...
          {/* Withdraw */}
          <div className="bg-red-100 p-8 rounded shadow">
            <h2 className="text-2xl font-bold text-red-700 mb-4">
              Withdraw
            </h2>
          ...
          <div className="mb-10 mt-30 d-flex text-end justify-center">
        <p className="font-bold">&copy;Content Owner: Ibna Mohammad Jonayet</p>
          </div>
        </div>
      </div>
    </div>
